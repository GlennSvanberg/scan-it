...
import { PhoneScanner } from '../components/phone-scanner.tsx'
import { PortraitScannerGate } from '../components/portrait-scanner-gate.tsx'
...
export type PhonePairingScreenProps = {
  publicId: string
}

/** Phone flow: open `/s/:publicId`, claim device, then scanner (web or desktop dev server). */
export function PhonePairingScreen({ publicId }: PhonePairingScreenProps) {
